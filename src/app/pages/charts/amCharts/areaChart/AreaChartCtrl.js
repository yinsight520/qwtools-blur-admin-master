...
(function () {
  ...
  /** @ngInject */
  function AreaChartCtrl($scope, $element, amChartFactory) {
    var layoutColors = amChartFactory.colors;

    var areaChart = amChartFactory.createChart($element, $scope, {
      type: 'serial',
      dataProvider: [
        ...
        { lineColor: layoutColors.danger,  date: '2012-01-08', duration: 309 },
