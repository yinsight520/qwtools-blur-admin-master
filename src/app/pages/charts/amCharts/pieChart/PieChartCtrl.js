...
(function () {
  ...
  /** @ngInject */
  function PieChartCtrl($element, $scope, amChartFactory) {
    var layoutColors = amChartFactory.colors;

    var pieChart = amChartFactory.createChart($element, $scope, {
      type: 'pie',
      startDuration: 0,
      addClassNames: true,
    ...
    pieChart.addListener('rollOverSlice', function (e) { handleRollOver(e); });
